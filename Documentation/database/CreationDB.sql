...
-- Listage de la structure de la table tpi. labyrinthe
CREATE TABLE IF NOT EXISTS `labyrinthe` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `labyrinthe_code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lenght` tinyint(4) NOT NULL,
...
-- Listage de la structure de la table tpi. users_does_labyrinthe
CREATE TABLE IF NOT EXISTS `users_does_labyrinthe` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `users_id` bigint(20) unsigned NOT NULL,
  `labyrinthe_id` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `users_does_labyrinthe_users_id_foreign` (`users_id`),
  KEY `users_does_labyrinthe_labyrinthe_id_foreign` (`labyrinthe_id`),
  CONSTRAINT `users_does_labyrinthe_labyrinthe_id_foreign` FOREIGN KEY (`labyrinthe_id`) REFERENCES `labyrinthe` (`id`),
  CONSTRAINT `users_does_labyrinthe_users_id_foreign` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
